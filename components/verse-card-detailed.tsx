...
import { Facebook, Twitter, Mail, Link as LinkIcon, Download } from 'lucide-react'
...
interface VerseCardDetailedProps {
  verse: {
    text: string
    reference: string
    verseId: string
...
export function VerseCardDetailed({ verse }: VerseCardDetailedProps) {
  ...
  const downloadImage = async () => {
    ...
    try {
      ...
      link.download = `bible-verse-${verse.verseId}.png`
      link.href = dataUrl
      link.click()
