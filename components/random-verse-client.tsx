    ...
    <div className="flex flex-col items-center">
      ...
      <div className="mb-10">
        <Button 
          onClick={randomize} 
          size="lg"
          className="gap-2 px-8 h-12 rounded-none shadow-lg hover:shadow-xl transition-all"
        >
      ...
      <div className="mt-8 flex flex-wrap justify-center gap-4">
        ...
        <Button variant="outline" size="icon" className="rounded-none" onClick={() => window.open(`mailto:?subject=Random Bible Verse&body=${encodeURIComponent(shareText + '\n' + shareUrl)}`, '_blank')}>
