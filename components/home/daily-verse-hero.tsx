  ...
  return (
    <section className="relative overflow-hidden bg-secondary py-16 lg:py-24">
      ...
      <div className="relative mx-auto max-w-3xl px-4 text-center lg:px-8">
        ...
        {displayVerse ? (
          <div
            className={`relative mx-auto max-w-xl overflow-hidden rounded-2xl border border-border/60 bg-card/80 p-4 shadow-sm backdrop-blur-sm ${selectedBackground.wrapperClass}`}
          >
                ...
                <div className="flex gap-1.5">
                  {BACKGROUNDS.map((bg) => (
                    <button
                      ...
                      className={`h-7 w-7 rounded-full border border-border/60 ring-offset-2 transition hover:scale-105 ${bg.previewClass} ${backgroundId === bg.id
                          ? "ring-2 ring-primary"
                          : "ring-0"
                        }`}
                    />
